...
public class SavisListDigitalCertificateApprovals extends BaseTest {
    ...
    public void beforeClass() {
        ...
        loginPage = new AdminLoginPageObject(SAVIS_ADMIN_LOGIN);
        homePage = loginPage.goToAdminHomePage();
    }

    public void goToHomPage() {
        homePage.openPageUrl(SAVIS_ADMIN_LOGIN);
    }
