...
public class GroupUserManager extends BaseTest {
    ...
    @Test
    public void TC_01_Goto_Group_User_Manager(Method method) {
        ExtentTestManager.startTest(method.getName(), "Go to Group User Manager");
//        goToHomPage();
